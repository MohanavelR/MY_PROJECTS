...
export const User_Card = () => {
   let users=[
    {id:1,name:"Mohan",sklils:['Java',"C++","C","Ui/Ux","Front Development","React",'Python'],city:'Salem',desc:"Full Stack Developer",is_online:true},
    {id:2,name:"Mohan",sklils:['Java',"C++","C","Ui/Ux","Back Development","React",'Python'],city:'Salem',desc:"Full Stack Developer",is_online:false},
    {id:3,name:"Mohan",sklils:['Java',"C++","C","Ui/Ux","Front Development","React",'Python'],city:'Salem',desc:"Web Developer",is_online:true},
